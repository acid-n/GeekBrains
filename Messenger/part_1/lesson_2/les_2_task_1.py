...
# os_type_list = []
#
# # Проверяем кодировку файла и меняем на UTF-8
# def check_coding(read_data):
#     with open(read_data, 'rb') as file:
#         content = file.read()
#
...
#     with open(read_data, 'r', encoding=file_encoding) as file:
#         content = file.read()
#
#     # сохраняем файл в кодировке utf-8
#     with open(read_data, 'w', encoding='utf-8') as file:
#         file.write(content)
#
#
# def get_data(read_data):
#     data = ['Изготовитель системы', 'Название', 'Код продукта', 'Тип системы']
...
#     for heading in data:
#         for i in text:
#             if re.match(heading, i):
#                 print(i)
#
#
# # Запускаем перебор файлов
